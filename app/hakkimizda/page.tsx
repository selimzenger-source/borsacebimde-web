  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <section className="card p-6 sm:p-8" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          Borsa Cebimde, Türkiye&apos;nin en güvenilir finans veri kaynaklarından bilgi derlemektedir.
          Kamuyu Aydınlatma Platformu (KAP), Sermaye Piyasası Kurulu (SPK), Bloomberg HT,
          BigPara ve Uzmanpara gibi kaynaklardan gelen veriler gerçek zamanlı olarak işlenmekte
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          gerek kalmadan en önemli gelişmeleri tespit etmesine yardımcı olmaktadır.
        </p>
      </section>
      ...
      <section className="card p-6 sm:p-8" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          Platformumuz modern web ve mobil teknolojileri kullanılarak geliştirilmiştir.
          Web sitemiz tüm tarayıcılarla uyumlu olup masaüstü ve mobil cihazlarda sorunsuz
          çalışmaktadır. Mobil uygulamamız ise hem Android hem de iOS işletim sistemlerinde
      ...
      <div className="flex flex-wrap gap-4 text-xs" style={{ color: 'var(--text-muted)' }}>
        ...
        <Link href="/kullanim-kosullari" className="hover:text-brand transition-colors">Kullanım Koşulları</Link>
        <Link href="/sss" className="hover:text-brand transition-colors">Sıkça Sorulan Sorular</Link>
        <Link href="/blog" className="hover:text-brand transition-colors">Borsa Rehberi</Link>
      </div>
    </div>
  );
}
