...
export default function ViopContent() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
              Son 10 gunun gece seansi verileri
            </p>
          </div>
      ...
      <InlineAppBanner
        title="VIOP Seanslarini Anlik Takip Edin!"
        message="Aksam ve gunduz seanslarini anlik takip edin, onemli gelismelerde bildirim alin."
      />
      ...
      {!loading && !error && groups.length === 0 && (
        <div className="card p-8 text-center text-sm" style={{ color: 'var(--text-muted)' }}>
          Son 10 gun icinde VIOP verisi bulunamadi.
        </div>
      )}
      ...
      <FAQ items={viopFAQ} title="VIOP Hakkinda Sikca Sorulan Sorular" />

      {/* ─── AppStore Banner ─── */}
      <AppStoreBanner message="Aksam ve gunduz seanslarini anlik takip edin!" />
    </div>
  );
}
