...
const FEATURES = [
  { emoji: '🔔', text: 'Anlik KAP Bildirimleri' },
  { emoji: '📊', text: 'Halka Arz Takibi' },
  { emoji: '🤖', text: 'AI Haber Analizi' },
  { emoji: '📈', text: 'Tavan / Taban' },
  { emoji: '💰', text: 'Tamamen Ucretsiz' },
];

const BANNERS = [
  {
    title: 'AI Destekli KAP Haberleri',
    desc: 'Yapay zeka ile analiz edilmis KAP bildirimleri aninda cebinizde',
  ...
  },
  {
    ...
    desc: 'Tum halka arzlari takip edin, bildirim alin, firsat kacirmayin',
  ...
  },
  {
    ...
    desc: 'Hisseleriniz tavana veya tabana gidince aninda haberiniz olsun',
  ...
  },
  {
    ...
    desc: 'Guncel ekonomi ve borsa haberleri, SPK bulten analizleri',
...
export default function IndirPage() {
  ...
  // Header/Footer/AdBanner gizle — bu sayfa full-screen landing page
  useEffect(() => {
    ...
    // AdBanner ve CookieConsent gizle
  ...
  return (
    ...
    >
        ...
        {BANNERS.map((b, i) => (
          <div
            ...
            style={{
              ...
              padding: '14px 18px',
              borderRadius: 16,
              background: `linear-gradient(135deg, ${b.gradient.includes('emerald') ? 'rgba(16,185,129,0.1)' : b.gradient.includes('blue') ? 'rgba(59,130,246,0.1)' : b.gradient.includes('amber') ? 'rgba(245,158,11,0.1)' : 'rgba(168,85,247,0.1)'}, rgba(0,0,0,0.1))`,
              border: `1px solid ${b.border.includes('emerald') ? 'rgba(16,185,129,0.2)' : b.border.includes('blue') ? 'rgba(59,130,246,0.2)' : b.border.includes('amber') ? 'rgba(245,158,11,0.2)' : 'rgba(168,85,247,0.2)'}`,
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 600, color: '#F1F5F9' }}>{b.title}</span>
            </div>
            <p style={{ fontSize: 12, color: '#94A3B8', lineHeight: 1.4 }}>{b.desc}</p>
          </div>
        ))}
      ...
      >
        ...
        <span style={{ fontSize: 12, color: '#64748B' }}>Ucretsiz & Reklamsiz Deneyim</span>
      </div>
      ...
      >
        ...
        <span style={{ fontSize: 10, color: '#334155', textAlign: 'center', maxWidth: 260, lineHeight: 1.4 }}>
          Bu uygulama yatirim tavsiyesi icermez. Yatirim kararlari tamamen kullanicinin sorumlulugundadir.
        </span>
      </div>
