...
const FEATURES = [
  { emoji: '\u{1F514}', text: 'Anlik KAP Bildirimleri' },
...
const BANNERS = [
  ...
  },
  {
    ...
    desc: 'Gunun tavan ve taban hisseleri ve sebepleri',
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
        ...
        >
          ...
          <Image
            ...
            style={{
              borderRadius: 22,
              position: 'relative',
              boxShadow: '0 8px 32px rgba(0,0,0,0.4), 0 0 60px rgba(59,130,246,0.1)',
            }}
            priority
          />
        </div>
            ...
            {BANNERS.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 5,
                  borderRadius: 3,
                  background: activeBanner === i ? '#60a5fa' : 'rgba(255,255,255,0.15)',
                  border: 'none',
                  cursor: 'pointer',
                  transition: 'all 0.3s',
                  padding: 0,
        ...
        {/* Download button — ONLY App Store */}
        <div
          style={{
            marginTop: 24,
            display: 'flex',
        ...
        >
          <a
            ...
            style={{
              ...
              fontWeight: 700,
              textDecoration: 'none',
              boxShadow: '0 4px 20px rgba(59,130,246,0.3), 0 2px 8px rgba(0,0,0,0.2)',
              transition: 'all 0.2s',
            }}
          >
            ...
            App Store&apos;dan Ucretsiz Indir
          </a>

          {/* Android link — secondary */}
          <a
            href="https://borsacebimde.app/androidindir"
            style={{
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            ...
            Android icin Google Play&apos;den indir
          </a>
        </div>
