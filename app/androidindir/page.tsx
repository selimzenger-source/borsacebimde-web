  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
        {/* Ambient glow — green for Android */}
        <div
          style={{
            position: 'absolute',
            top: -120,
        ...
        {/* Download button — ONLY Google Play */}
        <div
          style={{
            marginTop: 24,
            display: 'flex',
        ...
        >
          ...
          >
            ...
            Google Play&apos;den Ucretsiz Indir
          </a>

          {/* iOS link — secondary */}
          <a
            href="https://borsacebimde.app/appstoreindir"
            style={{
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            ...
            iPhone icin App Store&apos;dan indir
          </a>
        </div>
